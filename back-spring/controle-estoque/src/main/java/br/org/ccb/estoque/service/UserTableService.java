...
public class UserTableService {
    ...
    public void atualizarQuantidadeProduto(Long tabelaId, Long produtoId, int delta, String acao) {
    ...
    @SuppressWarnings("unchecked")
    public void adicionarProdutoNovo(Long tabelaId, ProductInTableDTO produto) {
        UserTable tabela = userTableRepository.findById(tabelaId)
                .orElseThrow(() -> new RuntimeException("Tabela não encontrada"));
